...
describe("Suite de Pruebas: Algoritmo de Busqueda Binaria", function () {
    ...
    it("Debe encontrar el ultimo elemento (caso borde superior)", function () {
        const array = [2, 4, 6, 8, 10];
        expect(busquedaBinaria(array, 10)).toBe(4);
    });

    it("Debe manejar correctamente un array vacio", function () {
        const array = [];
